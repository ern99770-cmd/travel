    ...
    <el-form :model="form" :rules="rules" ref="ruleForm">
      <el-row :gutter="10">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
                <el-form-item prop="scenicType" style="margin-bottom:0">
                    <el-select v-model="form.scenicType" size="mini" placeholder="请选择景点类型" style="width:100%">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
            ...
            <div style="width:100%">
                <el-form-item prop="location" style="margin-bottom:0">
                    <el-input v-model="form.location" size="mini" placeholder="请输入所在地区（如：北京市海淀区）" autocomplete="off"></el-input>
                </el-form-item>
            </div>
        </el-col>
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
